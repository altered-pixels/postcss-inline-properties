...
import plugin from 'postcss-inline-properties'
...
postcssTape(plugin)({
  ...
  'issue-838': {
    message:
      'prevent regressions of https://github.com/csstools/postcss-plugins/issues/838',
    options: {
      preserve: false,
    },
  },
  'issue-1377': {
    message:
      'prevent regressions of https://github.com/csstools/postcss-plugins/issues/1377',
  },
  specificity: {
